...
extern uint16_t pickOrder, placeOrder;
extern uint32_t firstShelvesPosition, secondShelvesPosition, thirdsecondShelvesPosition, fourthsecondShelvesPosition, fifthsecondShelvesPosition;
...
extern double Vfeedback, absVfb;
extern uint64_t usePWM, fPWM, thispwm;
extern int8_t motorDirection, isMotorCanMoveUp, isMotorCanMoveDown;
extern uint64_t home_timeStamp, home_trigger;

// remote
extern uint32_t ch2_timestamp;
extern int32_t ch2_xPosition, ch2_dt;
extern uint16_t ch2_Rise, ch2_Fall;
