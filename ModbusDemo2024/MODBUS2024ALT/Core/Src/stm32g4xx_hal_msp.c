...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM1CH1_EocoderA_Pin|TIM1CH2_EncoderB_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(TIM3CH1_JoySave_GPIO_Port, TIM3CH1_JoySave_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PA11     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(TIM4CH1_JoySel1_GPIO_Port, TIM4CH1_JoySel1_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB9     ------> TIM8_CH3
    */
    HAL_GPIO_DeInit(GPIOB, TIM8CH1_joyX_Pin|TIM8CH3_JoyZUp_Pin);
  ...
  /* USER CODE END TIM20_MspDeInit 0 */
    ...
    PC8     ------> TIM20_CH3
    */
    HAL_GPIO_DeInit(TIM20CH1_JoySel2_GPIO_Port, TIM20CH1_JoySel2_Pin);

    HAL_GPIO_DeInit(TIM20CH3_JoyZDown_GPIO_Port, TIM20CH3_JoyZDown_Pin);
